...
class GUI:
	...
	def createWidgets(self):
		...
		self.master.gradeLabel.grid(row=1, column=2, sticky=W)
		...
		self.master.gradeText.grid(row=1, column=3, sticky=W)
		...
		self.master.addButton.grid(row=1, column=4, sticky=E)
	...
	def validateCred(self, newText):
		"""
		Function to see if the entry Field of credText is valid numbers from 1 - 10.
